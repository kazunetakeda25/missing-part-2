...
Shader "Marmoset/Beta/Box Projection/Bumped Specular IBL" {
	Properties {
	...
	SubShader {
		...
		#pragma multi_compile MARMO_BOX_PROJECTION MARMO_BOX_PROJECTION_OFF		
	...
	FallBack "Marmoset/Mobile/Bumped Specular IBL"
}
