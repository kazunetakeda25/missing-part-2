...
public class dfRadarMain : MonoBehaviour
{
	...
	public dfControl directionIndicator;
	public bool rotateDirectionIndicator = false;
	...
	private void updateMarkers()
	{
		...
		{
			updateMarkers( markers[ i ] );
		}
	}

	private void updateMarkers( dfRadarMarker item )
	{
	...
	private void updateDirectionIndicator()
	{
		...
		var targetRot = target.transform.eulerAngles;
		var dir = new Vector3( 0, 0, -targetRot.y );

		if( rotateDirectionIndicator )
		{
			directionIndicator.transform.localEulerAngles = dir;
		}

		directionIndicator.BringToFront();
