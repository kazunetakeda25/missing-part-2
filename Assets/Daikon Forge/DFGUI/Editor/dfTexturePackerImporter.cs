...
public class dfTexturePackerImporter : EditorWindow
{
	...
	[MenuItem( "Assets/Daikon Forge/Import Texture Atlas" )]
	[MenuItem( "GameObject/Daikon Forge/Import Texture Atlas" )]
	...
	private void doImport()
	{
		...
		try
		{
			...
			dfTextureAtlasInspector.setAtlasTextureSettings( texturePath, FilterMode.Bilinear, false );
	...
	private Rect extractUVRect( DICT data, Texture2D atlas )
	{
